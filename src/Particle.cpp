...
Particle::Particle( float pos_x, float pos_y, float pos_z,
	...
	_life = life;
	_fade = fade;
	_position = new Vector3(pos_x, pos_y, pos_z);
	_speed = new Vector3(speed_x, speed_y, speed_z);
	_acceleration = new Vector3(acc_x, acc_y, acc_z);
	_color = new Vector3(color_r, color_g, color_b);	
}
